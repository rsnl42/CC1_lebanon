...
COUNTRY_ALIASES = {"country", "nation", "iso3", "country_name", "countryname"}
ADMIN1_ALIASES  = {"admin1", "state", "governorate", "province", "region",
                   "admin1name", "admin_1"}
ADMIN2_ALIASES  = {"admin2", "district", "county", "lga", "qadaa",
                   "sub-district", "subdistrict", "zone", "admin2name",
                   "admin_2", "woreda", "upazila", "kecamatan"}
...
def detect_col(columns: list[str], aliases: set[str], label: str) -> str | None:
